...
import work.usepdf.service.anotation.LoggingUpdateAnnotationPostBeenProcessor;
...
public class UsepdfApplication {
    ...
    @Bean
    public LoggingUpdateAnnotationPostBeenProcessor loggingUpdate(){
        return new LoggingUpdateAnnotationPostBeenProcessor();
    }
